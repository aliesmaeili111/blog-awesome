...
class Category(models.Model):
    ...
    title = models.CharField(max_length=155,verbose_name='عنوان دسته بندی')
    slug = models.SlugField(max_length=100,unique=True,verbose_name="آدرس دسته بندی")
    status = models.BooleanField(default=True,verbose_name="آیا نمایش داده شود؟")
    position = models.IntegerField(verbose_name="وضعیت دسته بندی")
...
class Article(models.Model):
    ...
    def thumbnail_tag(self):
        return format_html("<img src='{}'height=60 width=100 style ='border-radius:22px;'>".format(self.thumbnail.url))
